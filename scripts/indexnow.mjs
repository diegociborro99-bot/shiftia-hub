...
const DEFAULT_PATHS = [
  ...
  '/recursos/auditoria-cuadrante',
  '/recursos/plantilla-excel-cuadrante-turnos',
  '/recursos/turnos-rotativos-convenio-2026',
  '/recursos/registro-horario-residencias',
  '/recursos/reparto-equitativo-de-noches',
  '/software-turnos-residencias',
  '/cuadrantes-enfermeria-clinicas',
  '/turnos-hosteleria',
  '/software-cuadrantes-residencias',
  '/software-turnos-24-horas',
  '/software-turnos-call-center',
  '/shiftia-vs-aturnos',
  '/shiftia-vs-sesame-hr',
  '/mejores-software-turnos-espana',
  '/docs',
  '/sobre-nosotros',
  '/llms.txt',
];
