...
module.exports = {
  analyzeSchedule, sectorRule, DEFAULT_SHIFT_DEFS, MIN_REST_HOURS,
  // Ayudantes de cálculo horario: los reutiliza lib/roster-fix.js para que la
  // corrección mida los descansos exactamente igual que la auditoría.
  buildDefs, workedIntervals, absMinutes
};
